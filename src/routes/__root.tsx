...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Voyages organisés, circuits, croisières, Hajj & Omra et MICE. Découvrez le monde avec Capital Tours." },
      { name: "author", content: "Capital Tours" },
      ...
      { name: "twitter:site", content: "@CapitalTours" },
    ],
    links: [
      {
        rel: "stylesheet",
